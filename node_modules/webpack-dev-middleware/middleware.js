...
module.exports = function(compiler, options,req,res,next) {
...
console.log('HUURA');
	...
	function webpackDevMiddleware(req, res,next) {
		...
		function processRequest() {
			console.log('processRequest - filename',filename);
			try {
				var stat = context.fs.statSync(filename);
				console.log('stat',sstat.isFile());
				if(!stat.isFile()) {
					if(stat.isDirectory()) {
	...
	return webpackDevMiddleware(req,res,next);
};
